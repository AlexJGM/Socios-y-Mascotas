...
namespace Consola
{
    public class Controlador
    {
        ...
        public Controlador(GestorClub gestor)
        {
            ...
            {"Obtener Mascotas por especie",ListaMascotasEspecie},
            {"Obtener Mascotas por Edad", ListaMascotasEdad},
            {"Buscar mascotas de socio",buscarMascotasSocio},
            {"Cambiar el dueño de la mascota",cambiarDuenos},
            {"Ver lista de socios",verSocios},
            {"Dar socio de baja",bajaSocio},
            {"Registrar socio",darAltaSocio},
            {"Registrar mascota",registrarMascota},
